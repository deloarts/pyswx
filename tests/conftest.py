...
TEST_PART_01 = Path(TEST_OBJECTS, "test_part_01.sldprt")
TEST_PART_01_EXPORT_STEP = Path(TEST_OBJECTS, "test_part_01.step")
TEST_PART_02 = Path(TEST_OBJECTS, "test_part_02.sldprt")
...
def pytest_sessionstart():
    ...
    # Ensure test object folder
    os.makedirs(TEST_OBJECTS, exist_ok=True)
    if os.path.exists(TEST_PART_01):
        os.remove(TEST_PART_01)
